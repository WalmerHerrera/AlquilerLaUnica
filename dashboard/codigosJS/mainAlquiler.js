$(document).ready(function() {
    tablaAlquiler = $("#tablaAlquiler").DataTable({
        "columnDefs": [{
            "targets": -1,
            "data": null,
            "defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btnEditarAl'>Editar</button><button class='btn btn-danger btnBorrarAl'>Borrar</button></div></div>"
        }],
    ...
    //botón EDITAR    
    $(document).on("click", ".btnEditarAl", function() {
    ...
    //botón BORRAR
    $(document).on("click", ".btnBorrarAl", function() {
        fila = $(this).closest("tr");
